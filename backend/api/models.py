...
class UserProfile(models.Model):
    ...
    profile_photo = models.CharField(max_length = 200, default='https://www.1spotmedia.com/assets/theme/rjr/images/profile.png')
...
class TeacherInfo(models.Model):
    ...
    def __str__(self):
        return self.user.name + ': ' + str(self.is_teaching)
